...
button_load_task = tkinter.Button(
    window, text="Load tasks", width=48, command=load_tasks)
button_load_task.pack(pady=3)

button_save_task = tkinter.Button(
    window, text="Save tasks", width=48, command=save_tasks)
